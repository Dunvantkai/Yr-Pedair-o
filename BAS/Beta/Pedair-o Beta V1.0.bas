   ...
   90 X=3 : Y=0 : R=0 :AMSER=0 : DP=0 : LEAVE=FALSE :REM X Y AND ROTAION and amser time and SETAMSER AND DP=0 DOWN CHECK
   91 SETAMSER=1000000
 ...
 1840 IF K%=108 OR K%=76 THEN LEAVE=TRUE :REM PROC_RESET :REM L FOR EXIT
 1850 PROC_TIME
 1860 IF AMSER > SETAMSER THEN PROC_DOWN : AMSER=0
 1910 IF LEAVE=FALSE THEN GOTO 1780 :REM UNTIL FALSE FIX LATTER CANT BE LEFT  :REM 790
 1920 ENDPROC
 1930 DEF PROC_Print
