   ...
   95 DIM SCREEN$(14,21) : DIM SETHB$(3,3,3)  :FOR YA=0 TO 21 : SCREEN$(11,YA)=BL$ : NEXT YA :REM SCREAN SIZE AND SELECTED HITBOX FOR THE SPITES
  100 REM COLOUR
 ...
 1551 ENDPROC
 1552 DEF PROC_Title
 1553 CLS : XP=0 : XN=0 : RP=0 : DP=0 : AMSER=0
 ...
 1569 RAND%=7 :REM RAND%=RND(7)   :REM CHANGE BACK TO 7 AFTER DONE
 ...
 1850 PROC_TIME
 1860 IF AMSER=1000000 THEN PROC_DOWN
 ...
 2490 ENDPROC
 2500 DEF PROC_DOWN
 2510 FOR SX=0 TO 3 : FOR SY=0 TO 3 : IF SETHB$(R,SX,SY) = SCREEN$(SX+X,SY+Y+1) THEN DP=1 : NEXT SY : NEXT SX
 2520 IF DP=1 THEN SCREEN$(SX+X,SY+Y)=SCREEN$(SX+X,SY+Y)+SETHB$(R,SX,SY)
