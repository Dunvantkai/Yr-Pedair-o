 ...
 1215 PRINT : DIM SET$(3)
 1220 PRINT "PLEASE ENTER A SHAPE ID " ;
 1230 INPUT SEB$
 1240 IF SEB$="O" THEN FOR S=0 TO 3 SET$(S)=OBA$(S) NEXT S : CLS : PRINT GR$PRI$    :REM COMPY THE SELEECTED ARARY SEB$ TO SET TO DISPLAY SET$
 1250 IF SEB$="T" THEN FOR S=0 TO 3 SET$(S)=TBA$(S) NEXT S : CLS : PRINT GR$PRI$
 1260 IF SEB$="S" THEN FOR S=0 TO 3 SET$(S)=SBA$(S) NEXT S : CLS : PRINT GR$PRI$
 1270 IF SEB$="Z" THEN FOR S=0 TO 3 SET$(S)=ZBA$(S) NEXT S : CLS : PRINT GR$PRI$
 1280 IF SEB$="L" THEN FOR S=0 TO 3 SET$(S)=LBA$(S) NEXT S : CLS : PRINT GR$PRI$
 1290 IF SEB$="J" THEN FOR S=0 TO 3 SET$(S)=JBA$(S) NEXT S : CLS : PRINT GR$PRI$
 1300 IF SEB$="I" THEN FOR S=0 TO 3 SET$(S)=IBA$(S) NEXT S : CLS : PRINT GR$PRI$
