...
PRINTTAB(6,8)"The Speed is:" ; : IF SETAMSER=1000000 THEN PRINT """Exe Mode""" ELSE PRINT SETAMSER
PRINTTAB(2,10)"E - Change Brick Colours: "
PRINTTAB(6,11)"The Colours are: ""Rainbow"""
PRINTTAB(5,21)"L - TO GO BACK TO MAIN MENU"
REM -------OPTIONS-LOOP-------
K%=INKEY(0) :REM 1630
IF K%=81 OR K%=113 THEN PROC_ShapeID : GOTO 1588 :REM GOTO 1588  load shapes
IF K%=76 OR K%=108 THEN CLS : ENDPROC :REM BACK
