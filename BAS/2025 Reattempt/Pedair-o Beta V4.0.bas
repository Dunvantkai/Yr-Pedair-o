 ...
 1564 IF K%=76 OR K%=108 THEN CLS : PRINTTAB(4,5)"THANK YOU FOR PLAYER MY GAME ^^" : PRINTTAB(9,10)"MAKE BY"; : PRINT R$"Dunvant_Kai" : PRINTTAB(9,20)LBA$(0) :END : LEAVE GAME
 ...
 1955 FOR SX=0 TO 10 : FOR SY=0 TO 17 : PRINTTAB(SX+14,SY+3) SCREEN$(SX,SY) : NEXT SY : NEXT SX
 ...
 2520 IF DP=TRUE THEN PROC_CHECKREMOVELINE : FOR SX=0 TO 3 : FOR SY=0 TO 3 : SCREEN$(SX+X,SY+Y)=SCREEN$(SX+X,SY+Y)+SETHB$(R,SX,SY) : NEXT SY : NEXT SX : PROC_NEWBLOCK
 ...
 3075 IF THISREMOVEDLINE%<>0 THEN CLS
 3080 ENDPROC
