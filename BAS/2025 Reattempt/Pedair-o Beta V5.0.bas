   ...
   95 X=3 :Y=0 :R=0 :THISREMOVEDLINE%=0 :REM BLOCK X,Y,R POSITION AND ROTAION AND THE LINE THAT IS TO BE REMOVED
 ...
 1840 IF K%=108 OR K%=76 THEN LEAVE=TRUE        : FOR YA=0 TO 17 : FOR XA=0 TO 10 : SCREEN$(XA,YA)=SCREENBACK$(XA,YA) : NEXT XA : NEXT YA : ENDPROC : REM PROC_RESET :REM L FOR EXIT
 ...
 3075 IF THISREMOVEDLINE%<>0 THEN PROC_REMOVELINE
 3080 ENDPROC
