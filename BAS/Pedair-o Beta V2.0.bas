   ...
   98 AMSER=0 : DP=TRUE : LEAVE=FALSE : START=FALSE :REM AMSER TIME CLOCK. DP DOWN CHECK. LEAVE THE GAME
 ...
 1563 IF K%=32 THEN RAND%=RND(7)  : START=TRUE : PROC_Random : ENDPROC  :REM START GAME
