...
## Behind the name
I chose the name Pedair-o, which is Welsh for (The four of)as a nod to the name "tetris" as it is derived from the Greek prefix "tetra" meaning to having four parts (as every block in teras is make up of four blocks)
