...
To run Pedair-o on your computer you will first need to down load an emulater for the Acorn BBC Model B such as [BeebEm](https://github.com/stardot/beebem-windows/releases/download/4.19/BeebEm419.exe) 
